set dspExit [lsearch -exact [get_ips mulWeight] mulWeight]
if { $dspExit <0} {
create_ip -name dsp_macro -vendor xilinx.com -library ip -version 1.0 -module_name mulWeight
}
...
set_property generate_synth_checkpoint 0 [get_files mulWeight.xci] 

...
//    SpinalConfig(globalPrefix = "weight1").generateVerilog(new Rom(64,336,"simData/player1.coe").setName("weight1"))
    SpinalConfig(globalPrefix = "feature1").generateVerilog(new Rom(64,102400,"simData/add/dark2_CSP_m_Conv2(1).coe").setName("feature1"))
//    SpinalConfig(globalPrefix = "weight2").generateVerilog(new Rom(64,102400,"simData/add/dark2_CSP_m_Conv2(1).coe").setName("weight2"))
    SpinalConfig(globalPrefix = "feature2").generateVerilog(new Rom(64,102400,"simData/add/dark2_CSP_Conv1(3).coe").setName("feature2"))
}
